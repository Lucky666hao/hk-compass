...
export const HK_UNIVERSITIES: UniversityInfo[] = [
  ...
  // === 副学士 / 专上学院 ===
  {
    slug: 'hkcc',
    shortName: '香港专上学院',
    fullName: '香港專上學院 (Hong Kong Community College)',
    enName: 'HKCC',
    color: 'from-teal-600 to-cyan-700',
    bgClass: 'bg-teal-50 border-teal-200 dark:bg-teal-950/30 dark:border-teal-800',
    keywords: ['HKCC', '香港專上學院', '香港专上学院', 'Community College'],
    logo: '🎒',
  },
  {
    slug: 'hkuspace',
    shortName: '香港大学专业进修学院',
    fullName: '香港大學專業進修學院 (HKU SPACE)',
    enName: 'HKU SPACE',
    color: 'from-green-600 to-emerald-700',
    bgClass: 'bg-green-50 border-green-200 dark:bg-green-950/30 dark:border-green-800',
    keywords: ['HKU SPACE', 'HKUSPACE', '香港大學專業進修學院', '香港大学专业进修学院', '港大專業進修', '港大进修'],
    logo: '🌱',
  },
  {
    slug: 'hkbucie',
    shortName: '浸大国际学院',
    fullName: '香港浸會大學國際學院 (HKBU CIE)',
    enName: 'HKBU CIE',
    color: 'from-lime-600 to-green-700',
    bgClass: 'bg-lime-50 border-lime-200 dark:bg-lime-950/30 dark:border-lime-800',
    keywords: ['HKBU CIE', '浸大國際學院', '浸大国际学院', '浸會大學國際學院', '浸会大学国际学院', '持續教育學院', '持续教育学院'],
    logo: '📗',
  },
  {
    slug: 'cuhkscs',
    shortName: '中大专业进修学院',
    fullName: '香港中文大學專業進修學院 (CUHK SCS)',
    enName: 'CUHK SCS',
    color: 'from-violet-600 to-purple-700',
    bgClass: 'bg-violet-50 border-violet-200 dark:bg-violet-950/30 dark:border-violet-800',
    keywords: ['CUHK SCS', 'CUSCS', '中大專業進修', '中大专业进修', '中文大學專業進修學院', '中文大学专业进修学院'],
    logo: '📕',
  },
  {
    slug: 'cityuscope',
    shortName: '城大专上学院',
    fullName: '香港城市大學專上學院 (CityU SCOPE)',
    enName: 'CityU SCOPE',
    color: 'from-rose-600 to-red-700',
    bgClass: 'bg-rose-50 border-rose-200 dark:bg-rose-950/30 dark:border-rose-800',
    keywords: ['CityU SCOPE', '城大專上', '城大专上', '城市大學專上學院', '城市大学专上学院'],
    logo: '📘',
  },
  {
    slug: 'polyuspeed',
    shortName: '理大专业进修学院',
    fullName: '香港理工大學專業進修學院 (PolyU SPEED)',
    enName: 'PolyU SPEED',
    color: 'from-orange-600 to-amber-700',
    bgClass: 'bg-orange-50 border-orange-200 dark:bg-orange-950/30 dark:border-orange-800',
    keywords: ['PolyU SPEED', '理大專業進修', '理大专业进修', '理工大學專業進修學院', '理工大学专业进修学院'],
    logo: '📙',
  },
  {
    slug: 'hkct',
    shortName: '香港专业进修学校',
    fullName: '香港專業進修學校 (HKCT)',
    enName: 'HKCT',
  ...
  },
  {
    slug: 'lingnanlife',
    shortName: '岭南持续进修学院',
    fullName: '嶺南大學持續進修學院 (Lingnan LIFE)',
    enName: 'Lingnan LIFE',
    color: 'from-pink-600 to-fuchsia-700',
    bgClass: 'bg-pink-50 border-pink-200 dark:bg-pink-950/30 dark:border-pink-800',
    keywords: ['Lingnan LIFE', '嶺南持續進修', '岭南持续进修', '嶺南大學持續進修學院', '岭南大学持续进修学院'],
    logo: '📖',
  },
]
